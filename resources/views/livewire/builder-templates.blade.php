...
>
    @if($site)
        ...
        @if($open)
            @teleport('body')
                <div
                    class="fixed inset-0 z-[99999] flex items-center justify-center bg-zinc-950/80 p-4"
                ...
                >
                    <div
                        class="relative z-10 flex max-h-[calc(100vh-2rem)] w-full max-w-5xl flex-col overflow-hidden rounded-3xl border border-zinc-200 bg-white shadow-2xl dark:border-zinc-700 dark:bg-zinc-900"
                    >
