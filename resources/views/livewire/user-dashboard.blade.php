<div class="min-h-screen bg-zinc-50 dark:bg-zinc-950">
    <style>
        ...
        .dash-fade-up {
            animation: dash-fade-up .45s ease-out both;
        }
    ...
    <div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div class="relative overflow-hidden rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm sm:p-8 dark:border-zinc-800 dark:bg-zinc-900">
            ...
            <div class="relative flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
                <div>
                    <p class="inline-flex items-center gap-1.5 text-xs font-semibold uppercase tracking-wider text-indigo-600 dark:text-indigo-400">
                        <span class="size-1.5 rounded-full bg-indigo-500"></span>
                        Finder
                    </p>
                    <h1 class="mt-2 text-3xl font-bold tracking-tight text-zinc-950 sm:text-4xl dark:text-white">
        ...
        <div class="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            @foreach ([
                ['label' => 'Websites', 'value' => $sites->count(), 'icon' => 'globe-alt', 'accent' => 'text-indigo-600 bg-indigo-50 dark:text-indigo-400 dark:bg-indigo-500/10'],
                ['label' => 'Publicados', 'value' => $publishedCount, 'icon' => 'rocket-launch', 'accent' => 'text-emerald-600 bg-emerald-50 dark:text-emerald-400 dark:bg-emerald-500/10'],
            ...
            <div>
                <h2 class="text-lg font-semibold text-zinc-950 dark:text-white">
                    ...
                    @unless ($sites->isEmpty())
                        <span class="ml-1 align-middle text-sm font-medium text-zinc-400 dark:text-zinc-500">({{ $sites->count() }})</span>
                    @endunless
                </h2>
                    ...
                    >
                        ...
                        <div class="flex flex-1 flex-col p-5">
                            ...
                            <div class="mt-5 flex gap-2 border-t border-zinc-100 pt-4 dark:border-zinc-800">
                                ...
                                <flux:button
                                    class="flex-1 motion-safe:transition motion-safe:hover:-translate-y-0.5"
                                    variant="primary"
                                    href="{{ route('builder.edit', $site) }}"
                                    wire:navigate
                                >
                                    Editar
                                </flux:button>
