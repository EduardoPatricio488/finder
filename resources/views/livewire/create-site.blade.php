    ...
    <div class="mx-auto max-w-6xl" x-data="{ help: false }">
            ...
            <section class="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-900 sm:p-8">
                ...
                <div class="mt-8 grid gap-4 lg:grid-cols-3">
                    <div class="relative cursor-not-allowed rounded-2xl border border-zinc-200 bg-zinc-50 p-5 opacity-50 dark:border-zinc-700 dark:bg-zinc-800/60" aria-disabled="true">
                        ...
                        <p class="mt-1 text-xs leading-5 text-zinc-500">Opção avançada bloqueada. A geração inteligente já está incluída no modelo pessoal.</p>
                    </div>
                    <button type="button" wire:click="selectCreationMode('ai')" class="relative rounded-2xl border border-indigo-500 bg-indigo-50/70 p-5 text-left ring-2 ring-indigo-500/15 dark:bg-indigo-500/10">
                        ...
                        <h3 class="mt-4 font-bold">Modelo pessoal</h3>
                        <p class="mt-1 text-xs leading-5 text-zinc-500">A IA personaliza automaticamente o modelo Studio com o que nos contares.</p>
                    </button>
                    <div class="relative cursor-not-allowed rounded-2xl border border-zinc-200 bg-zinc-50 p-5 opacity-50 dark:border-zinc-700 dark:bg-zinc-800/60" aria-disabled="true">
                        <span class="absolute right-4 top-4 rounded-full bg-zinc-200 px-2.5 py-1 text-[10px] font-black uppercase tracking-wide text-zinc-500 dark:bg-zinc-700 dark:text-zinc-300">Bloqueado</span>
                        ...
                        <p class="mt-1 text-xs leading-5 text-zinc-500">Não é necessário começar de uma página vazia.</p>
                    </div>
                </div>
        ...
        @elseif($step === 2)
            <section class="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-900 sm:p-8">
                ...
                <h2 class="mt-2 text-2xl font-black">Modelo pessoal Studio</h2>
                <p class="mt-2 text-sm text-zinc-500">Esta versão está focada exclusivamente em websites pessoais.</p>
        ...
        @elseif($step === 3)
            <section class="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-900 sm:p-8">
                ...
                <p class="mt-2 text-sm text-zinc-500">A IA vai transformar estas poucas informações num website pessoal completo.</p>
        ...
        @else
            <section class="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-900 sm:p-8">
                ...
                <p class="mt-2 text-sm text-zinc-500">A IA prepara apenas o essencial para um website pessoal.</p>
