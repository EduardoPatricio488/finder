...
<html lang="pt-PT">
    <body style="margin:0;background:#f7f4ee;color:#1c1917;font-family:Arial,sans-serif;padding:32px">
        <div style="max-width:560px;margin:auto;background:#fff;padding:36px;border-radius:12px">
            <p style="color:#b45309;font-size:12px;font-weight:bold;letter-spacing:2px;text-transform:uppercase">{{ $siteName ?? config('app.name', 'Finder') }}</p>
            ...
            @endif
            <p style="margin-top:32px;font-size:13px;color:#78716c">Obrigado por utilizar a {{ $siteName ?? config('app.name', 'Finder') }}.</p>
        </div>
    </body>
</html>
